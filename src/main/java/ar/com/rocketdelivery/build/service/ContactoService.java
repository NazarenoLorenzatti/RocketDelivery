...
public class ContactoService {
	...
	public void crearContacto(String nombre, String apellido, String email, String telefono, String direccion,
			Usuario usuario) {
	...
	public ByteArrayOutputStream reporteClientes() {
		...
		List<String> cabeceros = Arrays.asList("ID", "Cliente", "Email", "Telefono", "Direccion");
